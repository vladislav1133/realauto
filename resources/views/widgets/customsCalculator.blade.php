<div class="container">
    <div>
        ...
        <ul class="nav nav-tabs" role="tablist">
            <li style="background: #ccc;" role="presentation" class="active"><a href="#light-car" aria-controls="light-car" role="tab" data-toggle="tab">light-car</a></li>
            <li style="background: #ccc;" role="presentation"><a href="#electric-car" aria-controls="electric-car" role="tab" data-toggle="tab">electric-car</a></li>
            <li style="background: #ccc;" role="presentation"><a href="#moto" aria-controls="moto" role="tab" data-toggle="tab">moto</a></li>
        </ul>
