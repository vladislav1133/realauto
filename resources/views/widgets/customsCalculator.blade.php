        ...
        <div role="tabpanel" class="tab-pane active" id="light-car">
            ...
            <form id="light-car-calculator" action="" class="custom-calc">
                <div>
                    ...
                    <input name='price' type="number" class="form-control custom-culc__input" value="20000" min="100"
                           max="1000000">
                ...
                <div>
                    ...
                    <select name="fuel" class="form-control custom-calc__fuel">
        ...
        <div role="tabpanel" class="tab-pane" id="electric-car">
            ...
            <form id="electric-car-calculator" class="custom-calc">
                ...
                <div>
                    ...
                    <input name="power" type="number" class="form-control custom-culc__input" value="80" min="1"
                           max="10000">
                </div>
        ...
        <div role="tabpanel" class="tab-pane" id="moto">
            ...
            <form id="moto-calculator" action="" class="custom-calc">
                ...
                <div>
                    ...
                    <input name='drive' type="number" class="form-control custom-culc__input" value="150" min="10"
                           max="20000">
                </div>
