                        ...
                        <div class="row">
                            ...
                            <div class="product__head">
                                <h3 class="product__title">
                                    <a href="https://www.copart.com/lot/{{$car->lot_id}}" class="product__name">{{$car->year}} {{$car->name}}, №{{$car->lot_id}} </a>
                                </h3>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <a class="details-button product__btn" href="https://www.copart.com/lot/{{$car->lot_id}}" target="_blank">
                                    Подробнее
                                </a>
                            </div>
                            <div class="col-lg-6">
